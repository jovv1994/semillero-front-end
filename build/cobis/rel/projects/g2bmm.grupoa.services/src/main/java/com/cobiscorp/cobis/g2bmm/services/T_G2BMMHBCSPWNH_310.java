/*
 * Archivo: T_G2BMMHBCSPWNH_310.java
 * Fecha: 2021-10-16T19:56:14Z
 *
 ...
 * T_G2BMMHBCSPWNH_310 - EstudianteLfyForm 
 *
 */
@Path("/G2BMM/FG2HX/T_G2BMMHBCSPWNH_310")
@Component
@Service({T_G2BMMHBCSPWNH_310.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=G2BMM)(task.submodule=FG2HX)(task.id=T_G2BMMHBCSPWNH_310)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANFT_540", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANFT_540)(view.version=1.0.0))")
...
public class T_G2BMMHBCSPWNH_310 {
