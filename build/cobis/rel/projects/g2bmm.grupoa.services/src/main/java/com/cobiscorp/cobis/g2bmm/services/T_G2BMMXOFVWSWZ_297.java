/*
 * Archivo: T_G2BMMXOFVWSWZ_297.java
 * Fecha: 2021-10-16T19:57:18Z
 *
 ...
 */
package com.cobiscorp.cobis.g2bmm.services;
 ...
 * T_G2BMMXOFVWSWZ_297 - EstudianteJovvForm 
 *
 */
@Path("/G2BMM/FG2HX/T_G2BMMXOFVWSWZ_297")
@Component
@Service({T_G2BMMXOFVWSWZ_297.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=G2BMM)(task.submodule=FG2HX)(task.id=T_G2BMMXOFVWSWZ_297)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANTV_674", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANTV_674)(view.version=1.0.0))")
...
public class T_G2BMMXOFVWSWZ_297 {
